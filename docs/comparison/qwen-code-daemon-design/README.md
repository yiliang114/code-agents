...
- 🎉 **Wave 1+2+2.5 完整 + Wave 3/4 五 PR 同飞**（2026-05-16~17 共 **16 MERGED + 5 OPEN**：13 Wave PRs + 3 follow-up MERGED + Wave 3 PR 13/14 + Wave 4 PR 16/18/21 在飞累计 **+12832 LOC**；doudouOUC 单日 12 PR；Wave plan 进度 13/31 ≈ 42%；**无 block 点**）：
  ...
  - 🔧 [PR#4251](https://github.com/QwenLM/qwen-code/pull/4251) Wave 3 PR 13 preflight + env diagnostics OPEN (doudouOUC, 2026-05-17 15:49, 回头补；GET /workspace/env + /workspace/preflight; 第一个 land closed errorKind 7-value taxonomy; 5 strict invariants 含 env_var 永不带 value + 永不 spawn ACP)
  - 🔧 [PR#4247](https://github.com/QwenLM/qwen-code/pull/4247) Wave 3 PR 14 MCP client guardrails OPEN (doudouOUC, 2026-05-17 14:58, 跳过 PR 13；counter + 3-mode budget + slot reservation by name + atomic check-reserve; 引 claude-code prior art)
  - 🔧 [PR#4249](https://github.com/QwenLM/qwen-code/pull/4249) Wave 4 PR 16 workspace memory + agents CRUD OPEN (doudouOUC, 2026-05-17 15:06, +2954/-3 项目第二大 PR；7 routes; Config Proxy fail-loud; whitespace-append suppression; pre-PR 2 specialist agent review)
  - 🔧 [PR#4250](https://github.com/QwenLM/qwen-code/pull/4250) Wave 4 PR 18 FileSystemService boundary OPEN (doudouOUC, 2026-05-17 15:19, +3270/-68 项目曾最大 PR；pure refactor 给 PR 19/20 chokepoint；8 security/correctness 防线 + SHA-256 path audit + 3 pre-PR agent / 5 P0+1 P1 pre-fix；引 claude-code + opencode prior art)
