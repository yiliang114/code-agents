...
- 🎉 **Wave 1+2+2.5+3+4 + W5 PR 22a+22b/1 + multi follow-up 同夜冲合**（2026-05-16~18 共 **35 MERGED + 5 OPEN/draft + 3 CLOSED**：22 Wave PRs + 7 follow-up + 3 bonus Stage 0 + 1 外部 + 2 refactor follow-up；PR 17 P2 fold-in + telemetry polish + 3 adapter draft；Wave plan 进度 **22.5/31 ≈ 73%**）：
  ...
  - 🔧 **F1** [PR#4319](https://github.com/QwenLM/qwen-code/pull/4319) acp-bridge self-sufficiency (原 PR 22b/3 + 22b' 合并) **OPEN CHANGES_REQUESTED** 2026-05-19 08:34 (doudouOUC, +5620/-4710 19 files, 5 rounds review; **`httpAcpBridge.ts` 4682 LOC → 97 LOC shim**; 4 lift step + 新 `BridgeFileSystem` 注入接口; 1221/1221 tests; target `daemon_mode_b_main` CI 不 fire)
