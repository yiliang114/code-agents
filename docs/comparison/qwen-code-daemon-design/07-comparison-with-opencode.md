...
| 持久化 | SQLite via drizzle-orm | JSON+JSONL → External Phase 1 SQLite（[§15 持久化栈](./15-orchestrator-multi-tenancy.md#四持久化栈大致方向)）|
