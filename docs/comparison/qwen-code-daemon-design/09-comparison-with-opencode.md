...
| 持久化 | SQLite via drizzle-orm | JSON+JSONL → External Phase 1 SQLite（[§21 持久化栈](./21-orchestrator-multi-tenancy.md#八引入-sqlite-的边界external-phase-1-orchestrator-层)）|
